...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds paypal one-off box code">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='promocodes', columnType='text', columnName='paypaloneoff', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='promocodes',columnName='paypaloneoff');
    </cfscript>
  </cffunction>
</cfcomponent>
