...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds quarterly discount option to promo codes">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='promocodes', columnType='string', columnName='paypalcodequarterly', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='promocodes',columnName='paypalquarterly');
    </cfscript>
  </cffunction>
</cfcomponent>
