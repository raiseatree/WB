...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds referral col">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='customers', columnType='string', columnName='referral', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='customers',columnName='referral');
    </cfscript>
  </cffunction>
</cfcomponent>
