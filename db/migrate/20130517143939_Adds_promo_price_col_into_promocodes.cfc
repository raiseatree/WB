...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds promo price col into promocodes">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='promocodes', columnType='integer', columnName='promoprice', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='promocodes',columnName='promoprice');
    </cfscript>
  </cffunction>
</cfcomponent>
