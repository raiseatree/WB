...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds summer holiday promo field to promo codes">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='promocodes', columnType='integer', columnName='blnsummerholiday', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='promocodes',columnName='blnsummerholiday');
    </cfscript>
  </cffunction>
</cfcomponent>
