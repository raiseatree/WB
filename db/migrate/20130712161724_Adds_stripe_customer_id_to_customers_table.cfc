...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds stripe customer id to customers table">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='customers', columnType='string', columnName='stripecustomerid', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='customers',columnName='stripecustomerid');
    </cfscript>
  </cffunction>
</cfcomponent>
