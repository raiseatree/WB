...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="promocodes">
  <cffunction name="up">
    <cfscript>
      t = createTable(name='promocodes');
      t.string(columnNames="code", default="", null=false, limit=255);
