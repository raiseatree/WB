...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds columns to promocode">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='promocodes', columnType='float', columnName='firstfee', default='', null=true);
	    addColumn(table='promocodes', columnType='integer', columnName='nodaysdelay', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='promocodes',columnName='setupfee');
		removeColumn(table='promocodes',columnName='message');
    </cfscript>
  </cffunction>
</cfcomponent>
