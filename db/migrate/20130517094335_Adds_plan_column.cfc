...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds plan column">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='customers', columnType='string', columnName='planname', default='fortnightly', null=false);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='customers',columnName='planname');
    </cfscript>
  </cffunction>
</cfcomponent>
