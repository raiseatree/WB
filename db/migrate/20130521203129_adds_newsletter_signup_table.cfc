...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="adds newsletter signup table">
  <cffunction name="up">
    <cfscript>
      t = createTable(name='newsletters');
      t.string(columnNames='firstname,surname,email', null=false, default='');
