...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds answer column to entrants table">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='entrants', columnType='string', columnName='answer', null=true);
    </cfscript>
  </cffunction>
