...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Adds source to entrants table">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='entrants', columnType='string', columnName='source', default='direct', null=false);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='entrants',columnName='source');
    </cfscript>
  </cffunction>
</cfcomponent>
