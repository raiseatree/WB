...
<html>
	...
	<body>
		...
		<section class="container">
			...
			<div class="row">
				<p><a href="http://www.weekendboxclub.com/daisygreen/confirm?code=#addEntry.ID#" class="btn btn-success btn-large">Confirm Competition Entry &raquo;</a></p>	
			</div>	
			...
			<div class="row">
				...
				<article class="clearfix">
					...
					<div class="span6">
		            	...
		            	<a href="http://www.weekendboxclub.com/daisygreen/purchase?code=#addEntry.ID#" class="btn btn-success btn-large">Buy Weekend Box for &pound;5 &raquo;</a>
		            </div>
	            </article>
