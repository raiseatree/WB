		...
		<section class="container">
			...
			<div class="row">
		        <header class="highlight span12">
		            <h2>Thanks for entering the Weekend Box competition, #addEntry.firstName#!</h2>
		            <h3>Please click the button below to confirm your entry</h3>               
				</header>
			</div>
		
			<div class="row">
				<p><a href="http://www.weekendboxclub.com/conquermaths/confirm?code=#addEntry.ID#" class="btn btn-success btn-large">Confirm Competition Entry &raquo;</a></p>	
			</div>	
			...
			<div class="row">
				...
				<article class="clearfix">
					<div class="span6 pull-left">
						<img src="http://www.weekendboxclub.com/images/splash-img.png" />
					</div>
					<div class="span6">
		            	...
		            	<a href="http://www.weekendboxclub.com/conquermaths/purchase?code=#addEntry.ID#" class="btn btn-success btn-large">Buy Weekend Box for &pound;5 &raquo;</a>
		            </div>
	            </article>
			...
			<div class="row clearfix">
				...
				<article class="clearfix">
		            ...
		            <div class="span9">
		            	...
		            	<p>What're your thoughts on our Weekend Boxes - feel free to drop me a line if you have any feedback or ideas you'd like to see.</p>
