		    ...
		    <div class="container">     	
		        <div class="row">
		            <article class="span4 center-align">
		            	...
		            	<p>We've sent you an email with all the important details like when your Summer Holiday Box will arrive.</p>
		            </article>
		             ...
		             <article class="span4 center-align">
		            	...
		            	<p>For <strong>every friend</strong> you refer, we'll donate an Activity Kit to our #linkTo(controller="main", action="about", anchor="christmas", text="Christmas Box Appeal")#</p>
		            </article>
