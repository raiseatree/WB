<cfparam name="data">
<cfparam name="params.plan" default="">
<cfoutput>

	<div class="row">        	
		<h2>Join The Weekend Box <strong>Summer Holiday</strong> Club</h2>
	</div>

	<section class="section-box shadow form">
	    <div class="container">     	
	        
	        #startFormTag(controller="summerholiday", action="register", class="form-horizontal")#
