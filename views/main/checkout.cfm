...
<cfoutput>
	...
	<div class="row">
		...
		<aside class="span4">
			...
			<p><i class="icon-calendar"></i> <cfif IsDate(SESSION.start_at)>#DateFormat(DateAdd("d", 4, SESSION.start_at), "dddd dd mmmm yyyy")#<cfelse>#SESSION.start_at#</cfif></p>
						...
						<div class="span7 card-box">
							...
							<cfif IsDefined("data.customer.code") AND data.customer.code GT ''>
								...
								<cfif data.customer.planName EQ 'one-off'>
									<cfif data.customer.paypalOneOff GT ''>
	...
	var fb_param = {};
	fb_param.pixel_id = '6006904195008';
	fb_param.value = '0.00';
	(function(){
	...
	<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/offsite_event.php?id=6006904195008&amp;value=0" /></noscript>
