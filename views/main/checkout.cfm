...
<cfoutput>
	...
	<div class="row">
		...
		<aside class="span4">
			...
			<p><i class="icon-calendar"></i> <cfif data.directDebit EQ true>#DateFormat(DateAdd("d", 4, data.payment.start_at), "dddd dd mmmm yyyy")#<cfelse>#DateFormat(data.payment.start_at, "dddd dd mmmm yyyy")#</cfif></p>
